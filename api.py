...
class PetFriends:
    ...
    def create_pet_simple(self, auth_key: json, name: str, animal_type: str, age: str) -> json:
        """Метод отправляет (постит) на сервер данные добавления фотографии к уже существующему питомцу,
    ...
    def pets_set_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
